...
** *qual é a "crise operacional"? falta de controle de entrada e saída de carros e numero de carros atendido.
...
- **Regras operacionais: Que seja de fácil manuseio
...
Cliente – pessoa que compra serviços ou produtos – número de identificação, telefone, endereço, formas de pagamento.

Veiculo – produto a ser realizado o serviço – número de identificação do carro, placa, modelo, marca, cor, ano, cliente.

Funcionários – pessoas que realizam os serviços – cliente, veiculo, nome, cargo, valor de pagamento

Serviços – atividades realizadas com objetivo financeiro – nome e tipo de serviço como lavagem simples, higienização e outros.

Pagamento – transação financeira – valor total, método de pagamento

Produto – material utilizado para executar o serviço e ou material de venda para o cliente realizar os cuidados com o carro. -  Veiculo, serviços, pagamento, funcionários, cliente
